...
public class ControlFlowGraph {
    ...
    public static class RPOBasicBlockIterator implements ListIterator<BasicBlock> {
        ...
        public BasicBlock next() { return rpo[++index]; }
        public int nextIndex() { return index+1; }
        public boolean hasPrevious() { return index >= 0 && rpo[index] != null; }
        public BasicBlock previous() { return rpo[index--]; }
        public int previousIndex() { return index; }
        public void remove() { throw new UnsupportedOperationException(); }
        public void add(BasicBlock bb) { throw new UnsupportedOperationException(); }
        public void set(BasicBlock bb) { throw new UnsupportedOperationException(); }

...
public class Dominators extends jq_MethodVisitor.EmptyVisitor implements BasicBlockVisitor {
    ...
    public void visitBasicBlock(BasicBlock bb) {
        ...
        bbs[bb.getID()] = bb;
        temp.setAll();
        Iterator<BasicBlock> preds = direction?bb.getPredecessors().iterator():
                                                  bb.getSuccessors().iterator();
        while (preds.hasNext()) {
        ...
        if (direction) {
            ...
            Iterator<ExceptionHandler> it = bb.getExceptionHandlers().exceptionHandlerIterator();
            while (it.hasNext()) {
                ExceptionHandler eh = (ExceptionHandler)it.next();
    ...
    public static class DominatorNode {
        ...
        public final ArrayList<DominatorNode> children;
        public BitString dominance_frontier;
        
        public DominatorNode(BasicBlock bb, DominatorNode parent) {
            this.bb = bb; this.parent = parent; this.children = new ArrayList<DominatorNode>();
        }
        ...
        public java.util.List<DominatorNode> getChildren() { return children; }
        ...
        public void dumpTree() {
            ...
            for (DominatorNode child : children) {
                child.dumpTree();
            }

...
public class ExceptionHandlerList extends java.util.AbstractList<ExceptionHandler> {
    ...
    public List<ExceptionHandler> mayCatch(jq_Class exType) {
        List<ExceptionHandler> list = new java.util.LinkedList<ExceptionHandler>();
        ExceptionHandlerList p = this;
        while (p != null) {
     ...
     * @return  the list of handlers that may catch the exception type
     */
    public List<ExceptionHandler> mayCatch(Collection<jq_Class> exTypes) {
        List<ExceptionHandler> list = new java.util.LinkedList<ExceptionHandler>();
        List<jq_Class> eTypes = new java.util.LinkedList<jq_Class>(exTypes);
        ExceptionHandlerList p = this;
        outer:
        while (p != null) {
            for (Iterator<jq_Class> i = eTypes.iterator(); i.hasNext(); ) {

...
public class BasicBlock {
    ...
    private BasicBlock() {
        ...
        this.successors = new java.util.ArrayList<BasicBlock>(1);
    ...
    private BasicBlock(int numOfExits) {
        ...
        this.predecessors = new java.util.ArrayList<BasicBlock>(numOfExits);
        this.exception_handler_list = null;
    }
    ...
    private BasicBlock(int id, int numOfPredecessors, int numOfSuccessors, int numOfInstructions,
        ...
        this.id_number = id;
        this.predecessors = new java.util.ArrayList<BasicBlock>(numOfPredecessors);
    ...
    public ListIterator<Quad> iterator() {
        if (instructions == null) return Collections.<Quad>emptyList().listIterator();
    ...
    public ListIterator<Quad> backwardIterator() {
        if (instructions == null) return Collections.<Quad>emptyList().listIterator();
        return new BackwardIterator(instructions.listIterator());
    }
    ...
    public void visitQuads(QuadVisitor qv) {
        for (Iterator<Quad> i = iterator(); i.hasNext(); ) {
            Quad q = i.next();
            q.accept(qv);
        }
    }
    ...
    public List<BasicBlock> getExceptionHandlerEntries() {
        ...
        List<BasicBlock> result = new java.util.ArrayList<BasicBlock>(exception_handler_list.size());
        for (ExceptionHandler eh : exception_handler_list) {
    ...
    public String fullDump() {
        ...
        sb.append(')');
        Iterator<ExceptionHandler> ehi = getExceptionHandlers().exceptionHandlerIterator();
        if (ehi.hasNext()) {

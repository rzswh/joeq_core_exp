                        ...
                        public void visitBasicBlock(BasicBlock bb) {
                            ...
                            if (!bb.isExit()) {
                                ...
                                while (qit.hasNext()) {
                                    ...
                                    Iterator<jq_Class> exceptions = quad.getThrownExceptions().iterator();
                                    while (exceptions.hasNext()) {
                                        allExceptions.add(exceptions.next());
                                    }
                                }
                                dot.userDefined("\t\"" + bb.toString() + "\" [shape=box,label=\"" + l + "\"];\n");

                                Iterator<BasicBlock> bit = bb.getSuccessors().iterator();
                                while (bit.hasNext()) {
                                    BasicBlock nextbb = bit.next();
                                    if (nextbb.isExit()) {
                                ...
                                while (eit.hasNext()) {
                                    ...
                                    Iterator<ExceptionHandler> mayCatch;
                                    mayCatch = bb.getExceptionHandlers().mayCatch(exc).iterator();

 ...
 * 
 * @author John Whaley
 * @version $Id: PrimitivePA.java,v 1.9 2006/03/09 01:10:16 mcmartin Exp $
 */
...
//        }
    ...
    public static void bdd_save(String filename, BDD b, List ds) throws IOException {
        ...
        try {
            ...
            if (out != null) try { out.close(); } catch (IOException _e) { }
        }
    }
    ...
    static void initPolyClasses() {
        ...
        if (f.exists()) {
            ...
            try {
                ...
                if (in != null) try { in.close(); } catch (IOException _e) {}
            }
        }
    }
